...
import 'package:flutter_empat_main/widgets/Project5widgets.dart';
...
class _Project5State extends State<Project5> {
  ...
  // Active user status (for 3-rd task)
  String? activeUserID;
  String? activeUserName;

  //Updater callback
  void setActiveUser(String id, String name) {
    setState(() {
      activeUserID = id;
      activeUserName = name;
    });
  ...
  List<Widget> get _pages => [
    _HomePage(activeUserID: activeUserID, onUserTap: setActiveUser),
    _NotificationsPage(),
    _ProfilePage(),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
        // Change UI for task 2 by pressing button
          activeUserID == null
              ? '${widget.title} "Discord at home"'
              : 'Active chat: $activeUserName',
...
class _HomePage extends StatelessWidget {
  ...
  final void Function(String id, String name) onUserTap;

  // Constructor with actual status and callback
  const _HomePage({required this.activeUserID, required this.onUserTap});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView(
                      children: [
                        // Give user a tap option
                        userBoxGrouped(context, activeUserID, onUserTap),
                      ],
                    ),
                  ),
                ],
